...
EJERCICIO 4#######################################################################
function ejercicio4(cad: string): Integer;

var
  pos: Integer;
const
  vocal: set of char = ['a', 'e', 'i', 'o', 'u', 'A', 'E', 'I', 'O', 'U'];
...
begin // inicio
  ...
  begin
    ...
    // o  esta dentro de   [ 'a','e','i','o','u', 'A','E','I','O','U']
    if (cad[i] in vocal) then
    begin
      pos := i; // pos= 2
      Break;
    end;
...
procedure TForm1Angel.EJERCICIO31Click(Sender: TObject);
begin
  // LLAMADA O ENLACE

  Edit2.Text := IntToStr(ejercicio3(cad));
end;
